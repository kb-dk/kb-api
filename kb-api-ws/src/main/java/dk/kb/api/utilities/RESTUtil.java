...
public class RESTUtil {
     ...
     * @return The HTTP response in form of String
     */
     ...
     * @param <T>          The requested response type
     * @return The HTTP response based on the given response type
     */
     ...
     *
     * @param path   Rest request path
     * @param params The map containing parameters in name-list pairs, whereas the list of each key contains 1 or more values.
     * @return The HTTP response in form of String
     */
     ...
     *
     * @param path   Rest request path
     * @param params The list containing parameters in name-list pairs, whereas the list of each key contains 1 or more values.
     * @return The HTTP response in form of String
     */
     ...
     *
     * @param path         Rest request path
     * @param params       The list containing parameters in name-list pairs, whereas the list of each key contains 1 value.
     * @param responseType Response type
     * @param <T>          The requested response type
     * @return The HTTP response based on the given response type
     */
     ...
     *
     * @param path         Rest request path
     * @param params       The map containing parameters in name-list pairs, whereas the list of each key contains 1 value.
     * @param responseType Response type
     * @param <T>          The requested response type
     * @return The HTTP response based on the given response type
     */
     ...
     * @param path         Rest request path
     * @param params       The map containing parameters in name-list pairs, whereas the list of each key contains 1 value.
     * @param xml          <CODE>true</CODE> if content type as XML
     * @param responseType Response type
     * @param <T>          The requested response type
     * @return The HTTP response based on the given response type
     */
     ...
     *
     * @return The OK response if service is online
     */
